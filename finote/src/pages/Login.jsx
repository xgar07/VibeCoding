...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.email.trim() || !form.password) {
      setFieldError('Isi email dan password terlebih dahulu.')
      return
    }
    ...
    if (error) {
      ...
      // Special case — show dedicated unverified modal
      ...
      toast.success('Selamat datang kembali! 👋', { duration: 2500 })
      navigate('/')
    }
  }
    ...
    <>
      ...
      {showUnverified && (
        <UnverifiedEmailModal
          ...
          onClose={() => setShowUnverified(false)}
        />
      )}
    </>
  )
